        ...
        <div className="min-vh-100 d-flex align-items-center justify-content-center py-4"
            ...
            <div className="card card-auth p-4" style={{ width: "100%", maxWidth: "480px" }}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row g-3 mb-3">
                        <div className="col-6">
                            ...
                            <input name="firstname" className="form-control input-custom"
                        ...
                        <div className="col-6">
                            ...
                            <input name="lastname" className="form-control input-custom"
                    ...
                    <div className="mb-3">
                        ...
                        <input name="email" type="email" className="form-control input-custom"
                    ...
                    <div className="mb-3">
                        ...
                        <input name="password" type="password" className="form-control input-custom"
                    ...
                    <div className="mb-4">
                        ...
                        <input name="dateOfBirth" type="date" className="form-control input-custom"
                ...
                <p className="text-center mt-3 small text-muted">
                    Déjà un compte ?{" "}
                    <Link to="/login" className="link-custom fw-semibold">Se connecter</Link>
                </p>
            </div>
        </div>
    );
